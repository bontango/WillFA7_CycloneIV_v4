    ...
    #create_clock -name {clk_50} -period 20.000 -waveform { 0.000 10.000 } [get_ports { clk_50 }]
	 create_clock -name root_clk -period 20.000 -waveform { 0.000 10.000 } [get_ports { clk_50 }]
    # #############################################################################
	...
	#
	# generated clocks
	create_generated_clock -name cpu_clk -divide_by 56 -source clk_50 cpu_clk_gen:clock_gen|clk_out	
	#create_generated_clock -name ff_clk -divide_by 25 -source clk_50 clk_5MHz_gen:ff_clock_gen|clk_out	
   #create_generated_clock -name dip_clk -divide_by 54000 -source clk_50 clk_900Hz_gen:CLK_RDIPS|clk_out
	#create_generated_clock -name blank_clk -divide_by 500 -source cpu_clk pia6821:PIA1|porta_data[2]
